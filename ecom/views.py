...
def add_to_cart_view(request,pk):
    ...
    product=models.Product.objects.get(id=pk)
    messages.info(request, product.name + ' ajouté au panier avec succès!')
...
def routeur_view(request):
    return render(request,'ecom/routeur.html')
